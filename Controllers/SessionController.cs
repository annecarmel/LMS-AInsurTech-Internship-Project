...
namespace ASSNlearningManagementSystem.Controllers
{
    public class SessionController : Controller
    {
        ...
        [HttpGet]
        public IActionResult TrainerSessions()
        {
            var trainerId = HttpContext.Session.GetInt32("UserId") ?? 0;

            var model = new SessionViewModel
            {
                SessionsList = _sessionRepo.GetAllSessionsByTrainer(trainerId)
            };

            return View("TrainerSessions", model);
        }
