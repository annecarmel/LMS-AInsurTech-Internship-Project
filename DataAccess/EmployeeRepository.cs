...
namespace ASSNlearningManagementSystem.DataAccess
{
    public class EmployeeRepository
    {
        ...
        // ✅ Added: Check if email exists (excluding current user)
        ...
        // ✅ Added: Check if phone number exists (excluding current user)
        public bool PhoneNumberExists(string phoneNumber, int? excludeUserId = null)
        {
            using (MySqlConnection conn = new MySqlConnection(_connectionString))
            {
